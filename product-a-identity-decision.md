...
`resolve_agent` is live (read-only) against the **official ERC-8004 Identity
Registry** at `0x8004A818BFB912233c491871b3d84c89A494BD9e` on **Ethereum
Sepolia**. This default lets hosted and local identity reads work without registry
configuration. Alternate deployments remain swappable via `EVM_RPC_URL` /
`ERC8004_CHAIN` / `ERC8004_REGISTRY_ADDRESS`.
