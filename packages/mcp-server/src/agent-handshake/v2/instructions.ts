...
export function buildV2Manifest(rawPin: unknown) {
  ...
  return Object.freeze({
    ...
    adapter: Object.freeze({
      package: "@d4d/local-adapter",
      install: "npx -y @d4d/local-adapter",
