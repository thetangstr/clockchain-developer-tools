...
// Env var the local adapter reads for its upstream endpoint; the published
// @d4d.group/local-adapter predates the /next split, so install snippets set
// it explicitly.
export const V2_ADAPTER_ENDPOINT_ENV = "CLOCKCHAIN_LOCAL_ADAPTER_ENDPOINT";
...
export function buildV2Manifest(rawPin: unknown) {
  ...
  return Object.freeze({
    ...
    adapter: Object.freeze({
      ...
      endpoint: V2_PUBLIC_ENDPOINT,
      endpointEnvVar: V2_ADAPTER_ENDPOINT_ENV,
      nodeRuntimeMajor: "24",
    }),
